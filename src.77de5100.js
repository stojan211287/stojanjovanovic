...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"noisejs/perlin.js":[function(require,module,exports) {
...
require("./styles.scss"); // Import NoiseJS ---> https://github.com/josephg/noisejs.git


var perlin_js_1 = require("./noisejs/perlin.js"); // Define starting seed for Perlin noise


var pageSeed = 567122400; // Perlin noise params

var perlinScale = 0.01;
var perlinStrength = 20; // Prepare canvas and context
...
function hexagon(x, y, r) {
  ...
  for (var i = 0; i < 6; i++) {
    var p = perlinize(x + Math.cos(angle) * r, y + Math.sin(angle) * r);
...
function perlinize(x, y) {
  var angle = perlin_js_1.noise.perlin2(x * perlinScale, y * perlinScale) * Math.PI;
  return {
...
function shade(x, y) {
  ...
  var shadeValue = (perlin_js_1.noise.perlin2(x * perlinScale, y * perlinScale) + 1) / 2; // Re-scale shade to [0, 255]

  var shadeRGB = 255 - shadeValue * 255;
  return "rgb(" + shadeRGB + "," + shadeRGB + "," + shadeRGB + ")";
}
/* Background drawing function */


function drawTiles(seed) {
  if (seed === void 0) {
    seed = pageSeed;
  } // Seed the Perlin noise function


  perlin_js_1.noise.seed(seed);
  updateCanvasSize();
  var radius = 10;
  var ydelta = Math.sin(Math.PI / 3) * radius;
  var even = true;

  for (var y = -ydelta; y < window.innerHeight + ydelta; y += ydelta) {
    var offset = 0;
    var yy = y;
    ...
    for (var x = -radius * 3; x < window.innerWidth + radius * 4; x += radius * 3) {
      context.beginPath();
...
drawTiles();
},{"./styles.scss":"styles.scss","./noisejs/perlin.js":"noisejs/perlin.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
